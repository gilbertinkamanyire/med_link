...
public final class ActivityScannerBinding implements ViewBinding {
  ...
  private ActivityScannerBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnClose,
      @NonNull View overlay, @NonNull PreviewView previewView, @NonNull TextView tvInstruction) {
  ...
  public static ActivityScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScannerBinding((ConstraintLayout) rootView, btnClose, overlay, previewView,
          tvInstruction);
    }
