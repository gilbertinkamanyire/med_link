...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull ImageButton btnConfig,
      @NonNull MaterialButton btnLogin, @NonNull TextInputEditText etLoginEmail,
      @NonNull TextInputEditText etLoginPassword, @NonNull TextView tvForgotPassword,
      @NonNull TextView tvGoSignup) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_go_signup;
      TextView tvGoSignup = ViewBindings.findChildViewById(rootView, id);
      if (tvGoSignup == null) {
        break missingId;
      }

      return new ActivityLoginBinding((ScrollView) rootView, btnConfig, btnLogin, etLoginEmail,
          etLoginPassword, tvForgotPassword, tvGoSignup);
    }
